      ...
      <div id="header" class="w-100 pb-lg-5 mb-1">
        <div class="container">
          <div class="row">
                ...
                <nav id="site-navigation" class="primary-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'kindergarten-education' ); ?>">
                  <?php 
                    ...
                    if(is_user_logged_in()){ ?>
                      <a href="<?php echo esc_url(site_url('/notebook'));?>"> Notebook </a>
            ...
            <div class="col-lg-1 col-md-1 col-6 align-self-right">
              <div class="main-search my-4 ps-2 align-self-right">
